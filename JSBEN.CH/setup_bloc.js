...
class RecipeDto {
    ...
    isValidSearchInput(inputValue) {
        ...
        let searchFilter = [...this.ingredients].filter((ingredient) => {
            return replaceSpecialChars(ingredient.toLowerCase()).includes(
                value
            );
        });
        ...
        return (
            isIngredExist ||
            replaceSpecialChars(this.name.toLowerCase()).includes(
                valueEscape
            ) ||
            replaceSpecialChars(this.description.toLowerCase()).includes(
                valueEscape
            )
        );
    }
    ...
    isInRecipe(selectedTags, recipeElements) {
        let selectedTagsArray =
            this.convertObjectToArrayInLowerCase(selectedTags);
